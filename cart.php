	...
	<div class="container-fluid">		
		...
		?>      
			...
			?>
				...
				<td class="text-end">&#8373 <?php echo $values["item_price"]; ?></td>
				<td class="text-end">&#8373 <?php echo number_format($values["item_quantity"] * $values["item_price"], 2); ?></td>
			...
			<td class="text-end">&#8373 <?php echo number_format($total, 2); ?></td>
			<td></td>
			</tr>
			</table>
			<div class="text-end">
